...
inline fun <reified T : Any> valueOf(): com.simplemobiletools.clock.extensions.gson.RuntimeTypeAdapterFactory<T> = com.simplemobiletools.clock.extensions.gson.RuntimeTypeAdapterFactory.of(T::class.java)
